...
int create_graph_matrix(int vertices_amount, int edges_amount, int **graph_matrix, int *used_vertices) {
    for (int i = 0; i < vertices_amount; i++) {
...
int main() {
    ...
    if (create_graph_matrix(N, M, graph_matrix, used_vertices) == -1)
        return 0;
